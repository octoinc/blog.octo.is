...
<p>Para esto se utilizan <a href="https://materialeslaboratorio.com/flujometro/" target="_blank"><b>flujómetros</b></a> de distinta precisión y funcionamiento, en donde destacan los del tipo <i>mecánico</i> y <i>electromagnético</i>, los cuales se adaptan al nodo Octopull para almacenarlos en la nube y crear distintas soluciones.</p><br>

<p style="text-align:center;"><img src="/images/sensor-flujo.jpeg" width="70%" height="auto" center></p><p class="tittle">Flujometro Octopull</p>
...
<p style="text-align:center;"><img src="/images/plataforma-flujometro.png" width="90%" height="auto" center></p><p class="tittle">Plataforma donde se muestra la data obtenida  por un flujometro</p>
